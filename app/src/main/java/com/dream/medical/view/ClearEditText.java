...
/**
 * Created by ASUS_FX_PRO on 2017/4/10.
 * <p>
 * 自定义的EditText带删除功能的EditText
 */
...
public class ClearEditText extends EditText implements
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            //throw new_msg NullPointerException("You can add drawableRight attribute in XML");
            mClearDrawable = getResources().getDrawable(R.mipmap.login_input_empty);
        }
        mClearDrawable.setBounds(-SizeUtils.dp2px(9), 0, mClearDrawable.getIntrinsicWidth() - SizeUtils.dp2px(9), mClearDrawable.getIntrinsicHeight());
        //默认设置隐藏图标
